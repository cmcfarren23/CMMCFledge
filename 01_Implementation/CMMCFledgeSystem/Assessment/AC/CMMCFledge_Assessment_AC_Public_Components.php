<?php 
    ...
    if(isset($_POST['PublicComponents'])){
        ...
        if($_SESSION['CMMCCertType'] == 'CMMC l1'){
            header("Location: ../IA/CMMCFledge_Assessment_IA_Major_IDP.php");
        }
        else if($_SESSION['IAASUsage'] != 'solely')
        ...
        <div class="bodyColumnContainer">
            <div class="bodyColumnWide">
                ...
                <div class = "questionRadioContainer">
                    ...
                    <div class = "singleSubmit"><?php include '../../Include/CMMCFledge_Public_Var.php'; echo "<progress id='progress-bar' max='" . getTotalQuestions() ."'value='10'></progress>";?></div>
                </div>
            </div>
        </div>
