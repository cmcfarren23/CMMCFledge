    ...
    <body>
        ...
        <div class="bodyColumnContainer">
            <div class="bodyColumnWide">
                <div class = "assessmentTitle">Does your system include a logon banner or notification upon initial logon?</div>
                ...
                <div class = "questionRadioContainer">
                    ...
                    <div class = "singleSubmit"><?php include '../../Include/CMMCFledge_Public_Var.php'; echo "<progress id='progress-bar' max='" . getTotalQuestions() ."'value='8'></progress>";?></div> 
                </div>
            </div>
        </div>
