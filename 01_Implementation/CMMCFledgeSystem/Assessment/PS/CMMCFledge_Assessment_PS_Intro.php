    ...
    <body>
        ...
        <div class="bodyColumnContainer">
            <div class="bodyColumnWide">
                <div class = "assessmentTitle">This section will cover general questions about Personnel Security (PS)</div>
                ...
                <div class = "questionRadioContainer">
                    <form method="post" >
                        <div class = "singleSubmit">
                            <a href ="CMMCFledge_Assessment_PS_Screening.php"><button type="button">Continue</button></a>
                        </div>
                    </form>
                    <div class = "singleSubmit"><?php include '../../Include/CMMCFledge_Public_Var.php'; echo "<progress id='progress-bar' max='" . getTotalQuestions() ."'value='48'></progress>";?></div>
                </div>
            </div>
        </div>
