    ...
    <body>
        ...
        <div class="bodyColumnContainer">
            <div class="bodyColumnWide">
                ...
                <div class = "assessmentSubTitle">(May be listed in current or future contract(s))</div>
                ...
                <div class = "questionRadioContainer">
                    ...
                    <div class = "singleSubmit"><?php include '../Include/CMMCFledge_Public_Var.php'; echo "<progress id='progress-bar' max='" . getTotalQuestions() ."'value='1'></progress>";?></div>
                </div>
            </div>
        </div>
